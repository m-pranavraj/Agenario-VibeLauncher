...
const DIMENSIONS = [
  ...
  { icon: Cpu,          label: "Architecture Review",    desc: "Code structure, coupling, complexity analysis" },
];
...
const FEATURE_ARSENAL: FeaturePill[] = [
  { icon: "🔍", label: "Secret Scanner",          bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "🛡️", label: "OWASP Top 10",          bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "💉", label: "SQL Injection Check",   bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "🔐", label: "Auth Security",         bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "⚡", label: "CSRF Protection",       bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "🌐", label: "CORS Check",           bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "🔑", label: "JWT Token Audit",      bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  { icon: "🔒", label: "Session Security",     bg: "bg-red-500/[0.06] border-red-500/20",    color: "text-red-300/80",    bgLight: "bg-red-50 border-red-200/60",    colorLight: "text-red-700",    glow: "hover:shadow-[0_0_12px_rgba(239,68,68,0.15)]"   },
  ...
  { icon: "♿", label: "Accessibility Audit",  bg: "bg-blue-500/[0.06] border-blue-500/20",  color: "text-blue-300/80",   bgLight: "bg-blue-50 border-blue-200/60",  colorLight: "text-blue-700",   glow: "hover:shadow-[0_0_12px_rgba(59,130,246,0.15)]"  },
  { icon: "🔗", label: "Vulnerability Scan",  bg: "bg-blue-500/[0.06] border-blue-500/20",  color: "text-blue-300/80",   bgLight: "bg-blue-50 border-blue-200/60",  colorLight: "text-blue-700",   glow: "hover:shadow-[0_0_12px_rgba(59,130,246,0.15)]"  },
  { icon: "🛒", label: "Checkout Flow Audit", bg: "bg-green-500/[0.06] border-green-500/20",color: "text-green-300/80",  bgLight: "bg-green-50 border-green-200/60",colorLight: "text-green-700",  glow: "hover:shadow-[0_0_12px_rgba(34,197,94,0.15)]"   },
  { icon: "🔔", label: "Webhook Security",    bg: "bg-green-500/[0.06] border-green-500/20",color: "text-green-300/80",  bgLight: "bg-green-50 border-green-200/60",colorLight: "text-green-700",  glow: "hover:shadow-[0_0_12px_rgba(34,197,94,0.15)]"   },
  { icon: "💸", label: "Revenue Leak Check",  bg: "bg-green-500/[0.06] border-green-500/20",color: "text-green-300/80",  bgLight: "bg-green-50 border-green-200/60",colorLight: "text-green-700",  glow: "hover:shadow-[0_0_12px_rgba(34,197,94,0.15)]"   },
  { icon: "📉", label: "Subscription Checks", bg: "bg-green-500/[0.06] border-green-500/20",color: "text-green-300/80",  bgLight: "bg-green-50 border-green-200/60",colorLight: "text-green-700",  glow: "hover:shadow-[0_0_12px_rgba(34,197,94,0.15)]"   },
  { icon: "🐌", label: "Query Performance",   bg: "bg-amber-500/[0.06] border-amber-500/20",color: "text-amber-300/80",  bgLight: "bg-amber-50 border-amber-200/60",colorLight: "text-amber-700",  glow: "hover:shadow-[0_0_12px_rgba(245,158,11,0.15)]"  },
  ...
  { icon: "🚀", label: "Cold Start Detection",bg: "bg-amber-500/[0.06] border-amber-500/20",color: "text-amber-300/80",  bgLight: "bg-amber-50 border-amber-200/60",colorLight: "text-amber-700",  glow: "hover:shadow-[0_0_12px_rgba(245,158,11,0.15)]"  },
  { icon: "🛡️", label: "Error Handling",      bg: "bg-orange-500/[0.06] border-orange-500/20",color: "text-orange-300/80",bgLight: "bg-orange-50 border-orange-200/60",colorLight: "text-orange-700",glow: "hover:shadow-[0_0_12px_rgba(249,115,22,0.15)]"  },
  { icon: "🔄", label: "Retry Logic Check",   bg: "bg-orange-500/[0.06] border-orange-500/20",color: "text-orange-300/80",bgLight: "bg-orange-50 border-orange-200/60",colorLight: "text-orange-700",glow: "hover:shadow-[0_0_12px_rgba(249,115,22,0.15)]"  },
  { icon: "⏱️", label: "Timeout Detection",   bg: "bg-orange-500/[0.06] border-orange-500/20",color: "text-orange-300/80",bgLight: "bg-orange-50 border-orange-200/60",colorLight: "text-orange-700",glow: "hover:shadow-[0_0_12px_rgba(249,115,22,0.15)]"  },
  { icon: "✅", label: "Input Validation",    bg: "bg-cyan-500/[0.06] border-cyan-500/20",  color: "text-cyan-300/80",   bgLight: "bg-cyan-50 border-cyan-200/60",  colorLight: "text-cyan-700",   glow: "hover:shadow-[0_0_12px_rgba(6,182,212,0.15)]"   },
...
const HOW_IT_WORKS = [
  ...
  { step: "02", title: "Analysis runs", desc: "Multiple security and quality checks run simultaneously across your codebase" },
