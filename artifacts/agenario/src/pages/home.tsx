...
const FEATURE_ARSENAL: FeaturePill[] = [
  ...
  { icon: "🧬", label: "Core Semantic Graph (CSG)",bg: "bg-violet-500/[0.06] border-violet-500/20",color: "text-violet-300/80",bgLight: "bg-violet-50 border-violet-200/60",colorLight: "text-violet-700",glow: "hover:shadow-[0_0_12px_rgba(139,92,246,0.2)]"   },
  { icon: "🌐", label: "Cross-Language Taint Tracer",bg: "bg-violet-500/[0.06] border-violet-500/20",color: "text-violet-300/80",bgLight: "bg-violet-50 border-violet-200/60",colorLight: "text-violet-700",glow: "hover:shadow-[0_0_12px_rgba(139,92,246,0.2)]"   },
  { icon: "🤖", label: "Dempster-Shafer Swarm Fusion",bg: "bg-violet-500/[0.06] border-violet-500/20",color: "text-violet-300/80",bgLight: "bg-violet-50 border-violet-200/60",colorLight: "text-violet-700",glow: "hover:shadow-[0_0_12px_rgba(139,92,246,0.2)]"   },
  { icon: "📸", label: "Playwright Exploit Proofs",bg: "bg-violet-500/[0.06] border-violet-500/20",color: "text-violet-300/80",bgLight: "bg-violet-50 border-violet-200/60",colorLight: "text-violet-700",glow: "hover:shadow-[0_0_12px_rgba(139,92,246,0.2)]"   },
  { icon: "⚡", label: "1-Click AI Auto-Fix & Prompts",bg: "bg-violet-500/[0.06] border-violet-500/20",color: "text-violet-300/80",bgLight: "bg-violet-50 border-violet-200/60",colorLight: "text-violet-700",glow: "hover:shadow-[0_0_12px_rgba(139,92,246,0.2)]"   },
