...
export default function AboutPage() {
  ...
  const STATS = [
    { value: stats?.proofsGenerated != null ? stats.proofsGenerated.toLocaleString() : "—", label: "Runtime Proofs", sub: "Generated by ephemeral browsers" },
    { value: stats?.issuesReproduced != null ? stats.issuesReproduced.toLocaleString() : "—", label: "Issues Reproduced", sub: "Undeniable exploits confirmed" },
    { value: stats?.fixesGenerated != null ? stats.fixesGenerated.toLocaleString() : "—", label: "Fixes Generated", sub: "Ready-to-paste git patches" },
    { value: "0", label: "Code Stored", sub: "Analyzed in memory only" },
  ];
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-20 sm:space-y-24 relative">
        ...
        >
          ...
          <motion.p variants={FADE_UP} className={`text-base sm:text-lg leading-relaxed max-w-2xl mx-auto ${isLight ? "text-gray-500" : "text-white/45"}`}>
            ...
            Agenario is a production review board that actively tests your application with business-aware attack packs and browser automation.
          </motion.p>
        </motion.div>
