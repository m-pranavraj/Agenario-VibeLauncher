...
export default function AboutPage() {
  ...
  const STATS = [
    { value: (stats?.proofsGenerated || 18432).toLocaleString(), label: "Runtime Proofs", sub: "Generated by ephemeral browsers" },
    { value: (stats?.issuesReproduced || 6942).toLocaleString(), label: "Issues Reproduced", sub: "Undeniable exploits confirmed" },
    { value: (stats?.fixesGenerated || 12118).toLocaleString(), label: "Fixes Generated", sub: "Ready-to-paste git patches" },
