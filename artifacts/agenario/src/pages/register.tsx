      ...
      >
        ...
        <div className={t.card}>
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-[10px] uppercase tracking-widest text-white/20 select-none font-bold">Or</span>
            <div className="h-px bg-white/[0.08] flex-1" />
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 font-bold py-3 rounded-xl border border-white/[0.08] hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.04] text-white transition-all text-sm shadow-sm"
          >
          ...
          <div className="flex items-center justify-center gap-1.5 mt-5 mb-4">
            <ShieldCheck className={`w-3.5 h-3.5 ${isLight ? "text-green-500" : "text-green-400/60"}`} />
