  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 ${t.page}`}>
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className={`absolute top-[-15%] left-[-5%] w-[50%] h-[50%] blur-[160px] rounded-full ${"bg-violet-600/[0.06]"}`} />
        <div className={`absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] blur-[140px] rounded-full ${"bg-blue-500/[0.04]"}`} />
      </div>
